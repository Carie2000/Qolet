(() => {
    ...
    const n = function(t) {
        ...
        m = function(t) {
            if (!t.getAll(this.field).every((t => t instanceof File && this.accept ? this.accept.some((e => /^\.[a-z0-9]+$/i.test(e) ? t.name.toLowerCase().endsWith(e.toLowerCase()) : (t => {
                    const e = [],
                    ...
                    return e
                })(e).some((e => (e = "." + e.trim(), t.name.toLowerCase().endsWith(e.toLowerCase())))))):false))) throw new o(this)
        },
        h = function(t) {
            if (!t.getAll(this.field).every((t => this.accept ? this.accept.some((e => t === String(e))):false))) throw new o(this)
        },
        u = function(t) {
            if (!t.getAll(this.field).every((t => {
                    const e = 0 === (i = new Date(t).getDay()) ? 7 : i;
                    var i;
                    return this.accept ? this.accept.some((t => e === parseInt(t))):false
                }))) throw new o(this)
        },
        w = function(t) {
